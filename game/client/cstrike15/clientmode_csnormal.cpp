...
{
	KisakPs4SetClientModeProbeEnabled( true );
	KisakPs4ClientModeBreadcrumb( this == GetFullscreenClientMode()
		? "fullscreen init entered"
		: "normal init entered", GET_ACTIVE_SPLITSCREEN_SLOT() );
	KisakPs4ClientModeBreadcrumb( "before shared init", GET_ACTIVE_SPLITSCREEN_SLOT() );
	BaseClass::Init();
	KisakPs4ClientModeBreadcrumb( "shared init ready", GET_ACTIVE_SPLITSCREEN_SLOT() );

	KisakPs4ClientModeBreadcrumb( "before match framework subscribe", GET_ACTIVE_SPLITSCREEN_SLOT() );
	g_pMatchFramework->GetEventsSubscription()->Subscribe( this );
	KisakPs4ClientModeBreadcrumb( "match framework subscribe ready", GET_ACTIVE_SPLITSCREEN_SLOT() );

	KisakPs4ClientModeBreadcrumb( "before game event listens", GET_ACTIVE_SPLITSCREEN_SLOT() );
	...
	KisakPs4ClientModeBreadcrumb( "game event listens ready", GET_ACTIVE_SPLITSCREEN_SLOT() );
	...
	// times per each one message generated by the server.
	//
	KisakPs4ClientModeBreadcrumb( "before message hooks", GET_ACTIVE_SPLITSCREEN_SLOT() );
	...
	KisakPs4ClientModeBreadcrumb( "message hooks ready", GET_ACTIVE_SPLITSCREEN_SLOT() );
	//
	// WARNING!! WARNING!! WARNING!! WARNING!! WARNING!! WARNING!! WARNING!! WARNING!!
	//

	KisakPs4ClientModeBreadcrumb( "before user message binds", GET_ACTIVE_SPLITSCREEN_SLOT() );
	...
	KisakPs4ClientModeBreadcrumb( "user message binds ready", GET_ACTIVE_SPLITSCREEN_SLOT() );

	KisakPs4ClientModeBreadcrumb( "before hud render groups", GET_ACTIVE_SPLITSCREEN_SLOT() );
...
// 	}
	...
	*/
	KisakPs4ClientModeBreadcrumb( "color corrections ready", GET_ACTIVE_SPLITSCREEN_SLOT() );
	KisakPs4ClientModeBreadcrumb( "before post process load", GET_ACTIVE_SPLITSCREEN_SLOT() );
	LoadPostProcessParamsFromFile();
	KisakPs4ClientModeBreadcrumb( "post process load ready", GET_ACTIVE_SPLITSCREEN_SLOT() );
	...
	KisakPs4ClientModeBreadcrumb( "before steam screenshots enable", GET_ACTIVE_SPLITSCREEN_SLOT() );
	EnableSteamScreenshots( true );
	KisakPs4ClientModeBreadcrumb( "steam screenshots enable ready", GET_ACTIVE_SPLITSCREEN_SLOT() );
	KisakPs4ClientModeBreadcrumb( "init complete", GET_ACTIVE_SPLITSCREEN_SLOT() );
	KisakPs4SetClientModeProbeEnabled( false );
}
