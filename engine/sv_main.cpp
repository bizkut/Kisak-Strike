...
#define PS4_GAME_SERVER_BREADCRUMB( line ) KisakPs4StartupBreadcrumb( line )
#else
#define PS4_GAME_SERVER_BREADCRUMB( line ) ((void)0)
#endif
#ifdef _LINUX
#include <syscall.h>
#endif
...
{
	PS4_GAME_SERVER_BREADCRUMB( "kisak-ps4: game server init entered" );
	PS4_GAME_SERVER_BREADCRUMB( "kisak-ps4: game server before base init" );
    BaseClass::Init( isDedicated );
	PS4_GAME_SERVER_BREADCRUMB( "kisak-ps4: game server after base init" );

    m_FullSendTables.SetDebugName( "m_FullSendTables" );
	PS4_GAME_SERVER_BREADCRUMB( "kisak-ps4: game server send tables named" );
	...
	#endif
	PS4_GAME_SERVER_BREADCRUMB( "kisak-ps4: game server init complete" );
}
